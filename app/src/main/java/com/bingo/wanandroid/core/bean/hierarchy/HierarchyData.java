package com.bingo.wanandroid.core.bean.hierarchy;
...
public class HierarchyData implements Serializable {
    ...
    private int visible;
    private List<HierarchyChildren> children;
    ...
    public List<HierarchyChildren> getChildren() {
        return children;
    }

    public void setChildren(List<HierarchyChildren> children) {
        this.children = children;
    }

    public static class HierarchyChildren implements Serializable{
        /**
         * children : []
         * courseId : 13
         * id : 60
